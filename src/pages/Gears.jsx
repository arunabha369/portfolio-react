...
export default function GearsPage() {
  return <Container className="py-16">
    <Helmet>
      <title>Gears | Arunabha Banerjee</title>
    </Helmet>
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col flex-wrap gap-4">
          {devices.map(device => <div key={device.name} className="flex items-center gap-4">
      ...
      <div className="space-y-4 pt-10">
        ...
        <div className="mt-8 flex flex-col flex-wrap gap-4">
          {webExtensions.map((extension, index) => <div key={extension.name} className="flex items-center gap-4">
      ...
      <div className="space-y-4 pt-10">
        ...
        <div className="mt-8 flex flex-col flex-wrap gap-4">
          {software.map((app, index) => <div key={app.name} className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="bg-muted flex items-center justify-center rounded-md border border-black/10 px-2 py-1 text-[#736F70] dark:border-white/10">
