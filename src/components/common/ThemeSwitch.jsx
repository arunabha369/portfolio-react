...
export const ThemeToggleButton = ({
  ...
  return <Button type="button" variant="ghost" size="icon" className={cn('size-10 cursor-pointer p-0 transition-all duration-300 active:scale-95', className)} onClick={toggleTheme} aria-label="Toggle theme">
