...
const Technology = ({
  ...
  return <div className="bg-muted/50 inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-sm font-medium">
...
const TechStack = ({
  ...
  return <div className="bg-muted/20 my-6 rounded-lg border p-4">
...
const ProjectMeta = ({
  ...
  return <div className="bg-muted/20 my-6 grid gap-4 rounded-lg border p-4 sm:grid-cols-2 lg:grid-cols-4">
      {timeline && <div>
...
const Challenges = ({
  ...
  return <div className="my-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-950/20">
...
const Learnings = ({
  ...
  return <div className="my-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-950/20">
