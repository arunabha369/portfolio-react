  ...
  return <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className={`${next ? '' : 'md:col-span-2'}`}>
          {previous ? <Button variant="outline" asChild className="group h-auto w-full justify-start p-4 text-left">
            ...
            </Button> : <div className="h-16" />}
        </div>

        {/* Next Project */}
        <div className={`${previous ? '' : 'md:col-span-2'}`}>
          {next ? <Button variant="outline" asChild className="group h-auto w-full justify-end p-4 text-right">
