...
function ScrollArea({
  ...
  return <ScrollAreaPrimitive.Root data-slot="scroll-area" className={cn('relative overscroll-contain', className)} {...props} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      <ScrollAreaPrimitive.Viewport data-slot="scroll-area-viewport" ref={viewportRef} className="focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1" style={{
      overflowY: 'auto',
