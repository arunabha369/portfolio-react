...
export const siteConfig = {
  ...
  author: {
    ...
    twitter: '@arunabha369',
    github: 'arunabha369',
    linkedin: 'arunabha369',
    email: 'arunabhabanerjee5@gmail.com'
  },
  keywords: ['portfolio', 'developer', 'full-stack', 'react', 'nextjs', 'typescript', 'web development', heroConfig.name.toLowerCase()]
};
