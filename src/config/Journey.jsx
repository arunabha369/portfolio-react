import { Book, FilmStrip, Laptop, Monitor, YoutubeLogo, ShareNetwork } from '@phosphor-icons/react/dist/ssr';
...
export const personalItems = [{
  ...
  description: 'Connect with me across my different social islands.',
  icon: ShareNetwork,
